    ...
    <div className="w-full lg:w-1/2 p-10 prose" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
      ...
      <div className="text-2xl text-white mt-8 leading-relaxed">
        <p>
          ...
          At some point during the reception, the bride will honor her Vietnamese heritage by changing into red clothing, so we kindly ask our guests to refrain from wearing red on this day. <br/><br/>
        ...
        <div className="w-full lg:w-1/3 py-8 px-10 grid grid-cols-4 gap-4 justify-center" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
          <div className="col-span-4 sm:col-span-4 relative">
            <img className="rounded-md object-cover mx-auto" src="/alykq3.jpg" alt="Titanic scene engagement photo" />
          </div>
        </div>
      </div>
    </div>
